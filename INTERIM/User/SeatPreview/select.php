...
<html lang="en" class="no-js">
	...
	<?php 
		...
		<header class="header">
			<h1 class="header__title"><a href="../index1.php">Home</a></h1>&nbsp &nbsp
			<h1 class="header__title">Theatre Seat Preview</h1>
		...
		<div class="container">
			<div class="cube">
				...
				<div class="cube__side cube__side--back">
					<div class="screen">
						<div class="video">
							<video class="video-player" src="media/logo.mp4" preload="auto" poster="media/logo5.png">
								<source src="media/sintel.ogg" type='video/ogg; codecs="theora, vorbis"'>
								<source src="media/logo.mp4" type='video/mp4; codecs="avc1.4D401E, mp4a.40.2"'>
						...
						<div class="intro intro--shown">
							<div class="intro__side">
								<h2 class="intro__title">
									<span class="intro__up">Silicon students initiative</span>
									<span class="intro__down">Trend Talkies <span class="intro__partial">presents</span></span>
								</h2>
							</div>
							<div class="intro__side">
		...
		<div class="plan">
			...
			<div class="rows rows--mini">
				<div class="row">
					<div class="row__seat tooltip" data-tooltip="A1" value="A1" onclick="A1()" id="A1"></div>
					<div class="row__seat row__seat--reserved"></div>
					<div class="row__seat tooltip" data-tooltip="A3"value="A3" onclick="A3()" id="A3"></div>
					<div class="row__seat row__seat--reserved"></div>
			...
			<ul class="legend">
				...
				<li class="legend__item legend__item--reserved">Restricted</li>
			...
			<!-- <div id='display' style="font-family: 'Poppins', sans-serif; margin-left: 40%; margin-bottom:3% "></div>
									   -->
			 <a href="../booking.php?movie_id=<?php echo $_SESSION['movie_id'];?>"> <button   class="action action--buy" name='submit'>Buy tickets </button></a>

			<!-- <button class="action action--buy">Buy tickets</button> -->
			<p class="header__title">Experience 3-D View <br>
			 Choose seats you want to book.<br>
			 Please Note the SeatNo.
		</p>
		</div><!-- /plan -->
