...
<div class=" border-right" id="sidebar-wrapper"  style="background-color: #13B2B8;">
  ...
  <div class="list-group list-group-flush">
    ...
    <a href="movie_bookings.php" class="list-group-item list-group-item-action" id="list"><i class="fas fa-users"></i>&nbsp User Bookings</a>
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="panel-heading" style="font-size: 150%; margin-left:1%;font-family: 'Poppins', sans-serif;"><b>User queries </b></div><hr>
                    ...
                    <table role="table" class="table-striped table-bordered" style="width: 100%;" >
									...
									<thead role="rowgroup">
										...
										<th role="columnheader">Id</th>
											...
											<th role="columnheader">Posting date</th>
